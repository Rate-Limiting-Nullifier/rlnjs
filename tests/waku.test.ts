...
// Test: can deserialize js-rln proof
// Test: can serialize to js-rln proof
describe("js-rln proof [de]serialization", () => {
  ...
  // A proof generated from rlnjs.
  let rlnFullProof: RLNFullProof

  // FIXME: as described in src/waku.ts, js-rln is **incompatible** with with our proof
  // since we don't use the same circuit. We should revisit this once js-rln is updated
  ...
  test.skip("RLN instance should verify the proof generated by js-rln", async () => {
