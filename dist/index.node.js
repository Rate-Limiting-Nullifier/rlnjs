...
function serializeFieldLE(field) {
    return ffjavascript.utils.leInt2Buff(field, SIZE_FIELD);
}
/**
...
function deserializeFieldLE(bytesLE) {
    return ffjavascript.utils.leBuff2int(bytesLE);
}
/**
...
function serializePointCompressed(curve, point, sizeCompressed) {
    var pointBigInt = ffjavascript.utils.unstringifyBigInts(point);
...
function deserializePointCompressed(curve, bytesLE, sizeCompressed) {
    ...
    return ffjavascript.utils.stringifyBigInts(curve.toObject(uncompressed));
}
/**
...
var RLN = /** @class */ (function () {
    function RLN(wasmFilePath, finalZkeyPath, verificationKey, rlnIdentifier, identity$1) {
        ...
        this.identity = identity$1 ? new identity.Identity(identity$1) : new identity.Identity();
...
var Registry = /** @class */ (function () {
    ...
    function Registry(treeDepth, zeroValue) {
        ...
        this._registry = new incrementalMerkleTree.IncrementalMerkleTree(poseidon, this._treeDepth, this._zeroValue, 2);
        this._slashed = new incrementalMerkleTree.IncrementalMerkleTree(poseidon, this._treeDepth, this._zeroValue, 2);
    }
